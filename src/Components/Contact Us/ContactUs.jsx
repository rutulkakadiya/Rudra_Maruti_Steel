...
import { Mail, Phone, MapPin, Clock, Send, Star, Sparkles, FileText } from 'lucide-react';
...
const ContactUs = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: 'Email',
      info: 'steel_maruti@yahoo.com',
      subInfo: 'Send Us a Message'
    },
    {
      icon: MapPin,
      title: 'Address',
      info: 'Maruti Steel Plot. No.-1, 3-Rani industrial area, Sarvay no.17, B/h. Purine furniture, Sahjanand marble`s street, Rajkot-Gondal highway, VAVDI (RAJKOT) 360004',
    },
  ];
  ...
  return (
    <div className="relative overflow-hidden">
            ...
            <div className='ps-[5%]'>
              ...
              <div className="space-y-6" data-aos="fade-right" data-aos-duration="1500">
                ...
                <div className="flex items-center gap-3 text-lg text-gray-700 font-medium">
                  <Phone className="text-[var(--brand-color)] text-2xl" />
                  <span>Contact Us</span>
                </div>

                <p className="text-gray-600 text-base lg:text-lg leading-relaxed max-w-md">
                  We’re here to help! Get in touch with us for any queries, support, or feedback.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="min-h-screen mt-8 sm:mt-12 md:mt-16 relative overflow-hidden">
        ...
        <div className="px-4 py-8 sm:py-12 mx-auto w-[95%]">
          <div className={`text-center mb-8 sm:mb-12 md:mb-16 transition-all duration-1000`} data-aos="fade-up" data-aos-duration="1500">
            <div className="flex items-center justify-center mb-4 sm:mb-6">
              ...
              <h1 className="heading-text text-3xl sm:text-4xl md:text-5xl font-bold text-black" style={{ fontFamily: "Rajdhani, sans-serif" }}>
                Get In <span className="heading-text text-[var(--brand-color)]" style={{ fontFamily: "Rajdhani, sans-serif" }}>Touch</span>
              </h1>
            ...
            <p className="text-gray-600 text-sm sm:text-base md:text-lg mt-4 sm:mt-6 max-w-xl sm:max-w-2xl mx-auto">
              Delivering strength and reliability in every product. Get in touch with us for all your steel requirements.
            </p>
          </div>

          <div className="grid grid-cols-12 gap-6 sm:gap-8 md:gap-12 w-full mx-auto">
            <div className={`transition-all col-span-7 duration-1000 delay-300 order-2 lg:order-1`}>
              <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 border border-gray-100 hover:shadow-3xl transition-all duration-300">
                <div className="flex items-center mb-6" data-aos="fade-right" data-aos-duration="1500">
                  <div className="bg-[var(--brand-color)] p-2 sm:p-3 rounded-full mr-3 sm:mr-4">
                    <Send className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                  </div>
                  <h2 className="heading-text text-2xl sm:text-3xl font-bold text-black" style={{ fontFamily: "Rajdhani, sans-serif" }}>Send Us a Message</h2>
                </div>
            ...
            <div className='order-1 lg:order-2 col-span-5' data-aos="fade-left" data-aos-duration="1500">
              <div className={`transition-all lg:col-span-4`} data-aos="fade-right" data-aos-duration="1500">
                <div className="space-y-6">
                  <h2 className="heading-text text-2xl sm:text-3xl font-bold text-black mb-6 sm:mb-8 flex items-center" style={{ fontFamily: "Rajdhani, sans-serif" }}>
                    ...
                    >
                      ...
                      <div className="flex items-start relative z-10">
                        <div className="bg-gradient-to-br from-[var(--brand-color)] to-[var(--brand-color)] p-2 sm:p-3 rounded-full mr-3 sm:mr-4 group-hover:scale-125 group-hover:rotate-12 transition-all duration-500 shadow-md group-hover:shadow-xl">
                          <item.icon className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:scale-110 transition-transform duration-300" />
                        </div>
                        <div className="flex-1 group-hover:translate-x-2 transition-transform duration-300">
                          <h3 className="heading-text font-bold text-black text-base sm:text-lg mb-1 group-hover:text-gray-900 transition-colors duration-300" style={{ fontFamily: "Rajdhani, sans-serif" }}>{item.title}</h3>
      ...
      <div className="px-4 mx-auto py-8 sm:py-12 w-[95%]">
        <div className="gap-6 sm:gap-8 md:gap-12 w-full mx-auto">


          <div className="shadow-lg lg:col-span-8 h-[60vh] flex justify-center items-center w-full order-1 lg:order-2 mt-6 sm:mt-8"
            data-aos="fade-left" data-aos-duration="1500">
            <iframe
              src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBkn10cBeoFz5AGnJ5gyabgpVHZGQfH7qE&q=Maruti Steel"
              width="100%"
              height="100%"
